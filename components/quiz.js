...
class Quiz extends Component {
  ...
  handleAnswer = (ans)=>{
    ...
    ans === currentAns ? correctCount+=1 : incorrectCount+=1
    this.setState({
    ...
    return (
          ...
          <View style={styles.container}>
            {currentQuesNo <= totalQues ?
              ...
              <Text h4>Question {currentQuesNo} ({`${leftQuestionNo} left`})</Text>
              <View style={{flex: 1, flexDirection: 'row',alignItems:'center'}}>

                <Text style={{fontSize: 22, fontWeight: '300'}}><Text style={{fontSize:22, fontWeight:'400'}}>Q: </Text>{this.state.questions[currentQuesNo-1].question}</Text>
              </View>
              ...
              <View style={{width:'100%', flex: 1.2, flexDirection:'column', justifyContent:'space-around'}}>
                {!this.state.showAnswer &&
                  <View>
                    <Button
                      raised
          ...
          <View style={{flex: 0.4, justifyContent: 'center', alignItems: 'center', marginTop:30}}>
